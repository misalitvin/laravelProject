            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <x-form-input type="number" name="price" id="price" step="0.01" placeholder="99.99" required />
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <textarea name="description" id="description" rows="3" class="w-full border rounded p-2" placeholder="Describe your product" required></textarea>
